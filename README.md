...
- There is a setting to keep the glucose graph for one hour displazed on the watch: Either on the watch, or in the phone "Watch" app, go to Settings -- General -- Return to Clock scroll down and tap on FLwatch and choose "After 1 hour". Like this, FLwatch stays for 1 hour in the foreground and gets a reasonable number of updates (like every minute).
