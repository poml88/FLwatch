...
//                                    LibreLinkUp: response data: {"status":4,"data":{"step":{"type":"pp","componentName":"AcceptDocument","props":{"reaccept":true,"titleKey":"Common.privacyPolicy","type":"pp"}},"user":{"accountType":"pat","country":"DE","uiLanguage":"de-DE"},"authTicket":{"token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..lJxNoaRE3w2JxjEWCeFO8DTeC-W2IgNrnpLpZmM9ldU","expires":1752821365,"duration":3600000}}}, status: 200
            ...
            if responseData.isEmpty {
                ...
                DebugMessageSingleton.shared.libreLinkUpResponseError = "Login: \(responseData) | error: \(errorAsString)"
            }
        ...
        do {
            ...
            do {
                ...
                if responseData.isEmpty {
                    ...
                    DebugMessageSingleton.shared.libreLinkUpResponseError = "getPatientGraph: \(responseData) | error: \(errorAsString)"
                }
                DebugMessageSingleton.shared.libreLinkUpOverlayError = ""
                throw LibreLinkUpError.jsonDecoding
            }
